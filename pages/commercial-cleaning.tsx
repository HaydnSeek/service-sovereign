...
import commercialCleaning from "../public/images/commercial-cleaning.jpeg"
    ...
    {/* <div className="bg-white">
      <div className="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="mt-1 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">Commercial Cleaning</h2>
          <p className="mt-4 text-lg text-gray-500">
          Our commercial cleaning services consist of cleaning on your schedule; designed to minimize interruptions to your business.  Our cleaning professionals are trained and experienced in the intricacies of commercial cleaning. Commercial cleaning services includes:
          </p>
        </div>
      ...
      <div className="relative bg-gray-800">
        <div className="h-56 bg-[#08a037] sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
          <Image
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="md:ml-auto md:w-1/2 md:pl-10">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Do you have a specific cleaning project in mind?</p>
            <p className="mt-3 text-lg text-gray-300">
            Contact us and we&apos;ll provide a customized solution that works for you!
            </p>
            <div className="mt-8">
